...
public final class ProcessUtils {
    ...
    public static String getForegroundProcessName() {
        ActivityManager am =
                (ActivityManager) UtilsBridge.app.getSystemService(Context.ACTIVITY_SERVICE);
        ...
        if (android.os.Build.VERSION.SDK_INT > android.os.Build.VERSION_CODES.LOLLIPOP) {
            PackageManager pm = UtilsBridge.app.getPackageManager();
            ...
            try {// Access to usage information.
                ApplicationInfo info =
                        pm.getApplicationInfo(UtilsBridge.app.getPackageName(), 0);
                AppOpsManager aom =
                        (AppOpsManager) UtilsBridge.app.getSystemService(Context.APP_OPS_SERVICE);
                if (aom.checkOpNoThrow(AppOpsManager.OPSTR_GET_USAGE_STATS,
                        info.uid,
                        info.packageName) != AppOpsManager.MODE_ALLOWED) {
                    intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    UtilsBridge.app.startActivity(intent);
                }
                if (aom.checkOpNoThrow(AppOpsManager.OPSTR_GET_USAGE_STATS,
                        info.uid,
                        info.packageName) != AppOpsManager.MODE_ALLOWED) {
                ...
                UsageStatsManager usageStatsManager = (UsageStatsManager) UtilsBridge.app
    ...
    public static boolean isMainProcess() {
        return UtilsBridge.app.getPackageName().equals(getCurrentProcessName());
    }
    ...
    private static String getCurrentProcessNameByAms() {
        try {
            ActivityManager am = (ActivityManager) UtilsBridge.app.getSystemService(Context.ACTIVITY_SERVICE);
            if (am == null) return "";
            List<ActivityManager.RunningAppProcessInfo> info = am.getRunningAppProcesses();
    ...
    private static String getCurrentProcessNameByReflect() {
        String processName = "";
        try {
            Application app = UtilsBridge.app;
