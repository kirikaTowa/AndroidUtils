...
object SDCardUtils  {
    ...
    class SDCardInfo internal constructor(
        ...
        init {
            totalSize = UtilsBridge.getFsTotalSize(path)
            availableSize = UtilsBridge.getFsAvailableSize(path)
        }
        ...
        override fun toString(): String {
            return "SDCardInfo {" +
                    ...
                    ", totalSize = " + Formatter.formatFileSize(UtilsBridge.app, totalSize) +
                    ", availableSize = " + Formatter.formatFileSize(
                UtilsBridge.app,
                availableSize
            ) +
                    '}'
        ...
        val sDCardInfo: List<SDCardInfo>
            get() {
                ...
                val sm =
                    UtilsBridge.app.getSystemService(Context.STORAGE_SERVICE) as StorageManager
                        ?: return paths
        ...
        val externalTotalSize: Long
            get() = UtilsBridge.getFsTotalSize(sDCardPathByEnvironment)
        ...
        val externalAvailableSize: Long
            get() = UtilsBridge.getFsAvailableSize(sDCardPathByEnvironment)
        ...
        val internalTotalSize: Long
            get() = UtilsBridge.getFsTotalSize(Environment.getDataDirectory().absolutePath)
        ...
        val internalAvailableSize: Long
            get() = UtilsBridge.getFsAvailableSize(Environment.getDataDirectory().absolutePath)
}