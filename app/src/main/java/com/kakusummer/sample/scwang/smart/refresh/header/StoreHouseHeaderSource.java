...
import com.kakusummer.sample.scwang.smart.refresh.header.storehouse.StoreHouseBarItem;
import com.kakusummer.sample.scwang.smart.refresh.header.storehouse.StoreHousePath;
...
public class StoreHouseHeaderSource extends SimpleComponent implements RefreshHeader {
    ...
    public StoreHouseHeaderSource(Context context) {
        this(context, null);
    }

    public StoreHouseHeaderSource(Context context, AttributeSet attrs) {
...
//        heightMeasureSpec = MeasureSpec.makeMeasureSpec(height, MeasureSpec.EXACTLY);
    ...
    public StoreHouseHeaderSource setLoadingAniDuration(int duration) {
        mLoadingAniDuration = duration;
        mLoadingAniSegDuration = duration;
        return this;
    }

    public StoreHouseHeaderSource setLineWidth(int width) {
        mLineWidth = width;
    ...
    public StoreHouseHeaderSource setTextColor(@ColorInt int color) {
        mTextColor = color;
        for (int i = 0; i < mItemList.size(); i++) {
    ...
    public StoreHouseHeaderSource setDropHeight(int height) {
        mDropHeight = height;
        return this;
    }

    public StoreHouseHeaderSource initWithString(String str) {
        initWithString(str, 25);
        return this;
    }

    public StoreHouseHeaderSource initWithString(String str, int fontSize) {
        List<float[]> pointList = StoreHousePath.getPath(str, fontSize * 0.01f, 14);
        initWithPointList(pointList);
        return this;
    }

    public StoreHouseHeaderSource initWithStringArray(int id) {
        final View thisView = this;
    ...
    public StoreHouseHeaderSource setScale(float scale) {
        mScale = scale;
        return this;
    }

    public StoreHouseHeaderSource initWithPointList(List<float[]> pointList) {
        ...
        if (success && mEnableFadeAnimation) {
            ...
            thisView.startAnimation(new Animation() {{
                ...
                protected void applyTransformation(float interpolatedTime, Transformation t) {
                    final View thisView = StoreHouseHeaderSource.this;
