...
public class WidgetProvider extends AppWidgetProvider {
    ...
    private PendingIntent getResetPendingIntent(Context context) {
        ...
        PendingIntent pi = PendingIntent.getBroadcast(context, 0, intent, PendingIntent.FLAG_MUTABLE | PendingIntent.FLAG_UPDATE_CURRENT);
        return pi;
    }
    ...
    private PendingIntent getOpenPendingIntent(Context context) {
        ...
        PendingIntent pi = PendingIntent.getActivity(context, 0, intent, PendingIntent.FLAG_MUTABLE | PendingIntent.FLAG_UPDATE_CURRENT);
        return pi;
    }
